...
static void fb_draw_char_internal(int x, int y, char c, int color, int bg_color, int scale) {
    ...
    /* Font data (same as before, just referencing the array) */
    /* We need to access the font array. Since it was defined inside the function in the original code, 
       we should move it out or duplicate it. 
       Wait, the original code had it inside fb_draw_char. 
       I will move the font array to file scope static const to share it.
    */
    /* ... actually, to avoid massive diffs, I'll keep the font here or assume it's moved. 
       Let's move the font array to the top of the file in a separate edit if needed, 
       but for now I will just include it here to be safe and self-contained, 
       or better, I will assume I can access it if I move it.
       
       Actually, the best way is to define the font array at file scope. 
       I will do that in a separate replacement chunk or just include it here.
       Since I am replacing the whole block including fb_draw_char, I can redefine the font here 
       or move it up. I'll define it static const at the top of this block.
    */
